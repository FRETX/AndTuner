package com.dawnofsoftware.tuner.androidtuner;

import java.util.Observable;
import java.util.concurrent.locks.Lock;
import java.util.concurrent.locks.ReentrantLock;

import com.dawnofsoftware.tuner.androidtuner.SoundAnalyzer.AnalyzedSound.ReadingType;
...
public class SoundAnalyzer extends Observable implements AudioRecord.OnRecordPositionUpdateListener {
	...
	private static int audioDataSize = 7200; // Length of sample to analyze. 7200
	
	// Additive increase, very-additive decrease.
	private static double notifyRateinS = 0.15; // should be 2 // 0.15
	...
	private static final double MPM = 0.7; // 0.7
